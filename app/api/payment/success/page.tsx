...
//   useEffect(() => {
//     // Optionnel : Mettre à jour le statut dans Supabase ici si Lygos ne l'a pas fait par Webhook
//     if (quoteId) {
//       supabase
//         .from("quotes")
//         .update({ status: "paid" })
...
//         <Link
//           href="/"
//           className="px-6 py-3 bg-white/10 rounded-lg hover:bg-white/20 transition-all flex items-center gap-2"
//         >
//           <Home className="w-4 h-4" /> Retour à l&apos;accueil
//         </Link>
//       </div>
